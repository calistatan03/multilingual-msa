...
def add_bins(df: pd.DataFrame) -> pd.DataFrame:
    """
    5-class label grouping based on y_true values:
      - negative:        {-1.0, -0.8}
    ...
    # Avoid floating point quirks (e.g. -0.6000000001)
    y = df["y_true"].round(1)
    ...
    # If you have other values (e.g. ±2/±3) this will catch them
    unknown = df["sentiment_class"].isna()
    if unknown.any():
        # you can either drop them or keep as "other"
